        ...
        Column {
            ...
            ScrollView {
                ...
                Column {
                    ...
                    // Таблица Additional Parameters для "6 Additional Parameters" меню (добавляем в Measured Parameters grid)
                    // Magnet PSU current for proton NMR
                        ...
                        // ========== Additional Parameters (добавляем в Measured Parameters grid) ==========
                        // Magnet PSU current for proton NMR
                        Row {
                            width: parent.width
                            spacing: 16
